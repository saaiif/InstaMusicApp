...
function Player(props) {
	return (
		<div className={classes.playerContainer}>
			<audio ref={props.audioRef} onTimeUpdate={props.songProgress} onEnded={props.songEnd}>
			...
			<div className={classes.progressBarWrapper} onClick={props.seekClick}>
				<div className={classes.progressBar} style={{ width: `${props.trackProgress}%` }} />
			</div>
			<div className={classes.Icons}>
				...
				{props.SongPlayStatus ? (
					...
					<i className="far fa-play-circle pBtn" onClick={props.playSong} title="play" />
				)}
				<i className="fas fa-step-forward" onClick={props.nextSong} title="next" />
				<i
